...
func assaultRifle_mods():
	if hasAttachedMod1 == true:
		$M4/Mods/Silencer2.visible = true
	if hasAttachedMod2 == true:
		$M4/Mods/LazerGreen.visible = true
	else:
		$M4/Mods/Silencer2.visible = false
		$M4/Mods/LazerGreen.visible = false
#Shooting method
func assaultRifle_fire():
	var bullet_instance = M4A1_bulletPath.instance()
	bullet_instance.position = $M4/Muzzle.get_global_position()
...
func toggle_lazer():
	var lazer_attachment = $M4/Mods/LazerBeam
